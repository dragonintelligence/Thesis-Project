...
PER_LAT: list = [64, 128] # to test
PER_HEADS: list = [8, 12, 16] # to test
PER_DEPTH: list = [[1, 2, 4, 8], [1, 2, 3, 4, 6, 12], [1, 2, 3, 4, 6, 8, 12, 24]] # to test
