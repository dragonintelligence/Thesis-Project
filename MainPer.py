...
print("Best Perceiver Learning rate")
print(f"Per - {list(f1_score.keys())[0]}: accuracy {accuracy[list(f1_score.keys())[0]] * 100 :.3f} % and F1 score {list(f1_score.values())[0] :.3f}")